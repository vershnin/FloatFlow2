...
public class JwtService {
    ...
    /**
     * Includes userId, role, and branchId in the claims for easy frontend access.
     */
    ...
    /**
     * Decode the Base64 secret into raw bytes for HMAC-SHA256 signing.
     */
